...
class ScNumberedSetTestCase(BaseTestCase):
    ...
    def test_create_large(self):
        ...
        sc_set = AScNumberedSet(*elements)
    ...
    def test_create_copy_num_set_node(self):
        ...
        element2 = create_node(sc_types.NODE_CONST)
        sc_set = AScNumberedSet(element1, element2)
        sc_set_copy = AScNumberedSet(set_node=sc_set.set_node)
        self._assert_two_elements_num_set_template(sc_set_copy.set_node, element1, element2)

    def test_add(self):
        element1 = create_node(sc_types.NODE_CONST)
        sc_set = AScNumberedSet(element1)
        element2 = create_node(sc_types.NODE_CONST)
        sc_set.add(element2)
        self._assert_two_elements_num_set_template(sc_set.set_node, element1, element2)
    ...
    def test_iterate(self):
        ...
        sc_set = AScNumberedSet(*elements, set_node=set_node)
    ...
    def test_get_by_index(self):
        ...
        element1 = create_node(sc_types.NODE_CONST)
        sc_set = AScNumberedSet(element0, element1)
    ...
    def test_contain(self):
        ...
        sc_set = AScNumberedSet(element_in)
    ...
    def test_remove(self):
        ...
        element2 = create_node(sc_types.NODE_CONST)
        sc_set = AScNumberedSet(element1, element_to_remove, element2)
